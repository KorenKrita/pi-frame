/**
 * Statusline, ported from pi-topping-statusline (MIT, see LICENSE in this
 * directory), which is itself oh-my-pi's statusline as a pi extension.
 *
...
import { makeBoxPainters, renderBoxRow, renderBoxRowIfVisible } from "./box.js";
import { SegmentContextBuilder } from "./context.js";
import {
...
import { RAINBOW_DEG_PER_FRAME, RAINBOW_FRAME_MS, RainbowBorder, type BorderColorizer } from "./rainbow.js";
import { openStatuslineSettings } from "./settings-menu.js";
import { createSettingsState, topLeftSegments } from "./settings.js";
import { theme } from "./theme.js";
import { TokenRateMonitor } from "./token-rate.js";
import { isMessageKind, type StatusIndicatorKind, StatusTransition } from "./working-status.js";
type EditorFactory = NonNullable<ReturnType<ExtensionContext["ui"]["getEditorComponent"]>>;

const WORKING_FADE_FRAME_MS = 30;

export function installStatusline(pi: ExtensionAPI) {
	...
	return {
		openSettings: (ctx: ExtensionCommandContext) => openStatuslineSettings(ctx, state, builder, onSettingsChange),
	};
}
