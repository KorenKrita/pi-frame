...
export class SegmentContextBuilder {
	...
	dispose(): void {
		...
		this.#ctx = undefined;
		// An in-flight #resolveRepo checks this before installing the HEAD watcher;
		// without the reset it would install one after disposal and leak it.
		this.#repoCwd = undefined;
		this.#clearFeedLifecycle();
	}
